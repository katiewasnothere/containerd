...
func init() {
	plugin.Register(&plugin.Registration{
		...
		InitFn: func(ic *plugin.InitContext) (interface{}, error) {
			...
			localClient.UpdateLocalPlugins(allPluginsPB)
			localClient.UpdateLocalRoot(ic.Root)
...
func (s *service) Server(ctx context.Context, empty *ptypes.Empty) (*api.ServerResponse, error) {
