...
type IntrospectionService interface {
	...
	Server(context.Context, *ptypes.Empty) (string, error)
}
...
var _ = (IntrospectionService)(&introspectionRemote{})

func NewIntrospectionServiceFromClient(c api.IntrospectionClient) IntrospectionService {
...
func (i *introspectionRemote) Server(ctx context.Context, _ *ptypes.Empty) (UUID string, err error) {
	resp, err := i.client.Server(ctx, nil)
